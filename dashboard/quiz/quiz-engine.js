...
const dom = {
    ...
    loadingMessage: document.getElementById('loading-message') // NEW: Loading message element
};
...
// NEW: Helper function to update the loading message
